...
$tujuan_index = "detail_invoice.php";
...
mysqli_query($koneksi, "DELETE FROM tb_pesanan WHERE invoice= '$_GET[invoice]'") or die(mysqli_error($koneksi));
mysqli_query($koneksi, "DELETE FROM tb_keranjang WHERE invoice= '$_GET[invoice]'") or die(mysqli_error($koneksi));
